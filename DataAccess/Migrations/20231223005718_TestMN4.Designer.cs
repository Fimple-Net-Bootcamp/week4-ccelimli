...
namespace DataAccess.Migrations
{
    ...
    [Migration("20231223005718_TestMN4")]
    partial class TestMN4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Concretes.SocialInteraction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Entity.Concretes.SocialInteractionMapPet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("DestinationPetId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SocialInteractionMapPets");
                });
            ...
            modelBuilder.Entity("Entity.Concretes.SocialInteractionMapPet", b =>
                {
                    b.HasOne("Entity.Concretes.Pet", null)
                        .WithMany("SocialInteractionMapPets")
                        .HasForeignKey("PetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Concretes.SocialInteraction", null)
                        .WithMany("SocialInteractionMapPets")
            ...
            modelBuilder.Entity("Entity.Concretes.TrainingMapPet", b =>
                {
                    b.HasOne("Entity.Concretes.Pet", "Pets")
                        .WithMany("TrainingMapPets")
                        .HasForeignKey("PetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Concretes.Training", "Trainings")
                        .WithMany("TrainingMapPets")
            ...
            modelBuilder.Entity("Entity.Concretes.Pet", b =>
                {
                    ...
                    b.Navigation("SocialInteractionMapPets");

                    b.Navigation("TrainingMapPets");
                });
