...
{
    public class UpdateActivityValidator : AbstractValidator<UpdateActiviyRequest>
    {
        public UpdateActivityValidator()
        {
            RuleFor(activity => activity.Id).NotEmpty().WithMessage(Messages.NotEmptyActiviteInfo);
